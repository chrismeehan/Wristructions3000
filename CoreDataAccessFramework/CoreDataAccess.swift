...
public class CoreDataAccess: NSObject {
    
    public class var sharedInstance : CoreDataAccess {
        struct Static {
            static var onceToken : dispatch_once_t = 0
            static var instance : CoreDataAccess? = nil
        }
        dispatch_once(&Static.onceToken) {
            Static.instance = CoreDataAccess()
        }
    ...
    public func getLatestDate()-> NSDate? {
        ...
        do{
            ...
            do{
                try CoreDataAccess.sharedInstance.managedObjectContext?.save()
            }
            catch{
    ...
    public lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Wristructions", withExtension: "momd")!
    ...
    public lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let containerPath = NSFileManager.defaultManager().containerURLForSecurityApplicationGroupIdentifier("group.watch.com.meehan")!.path
